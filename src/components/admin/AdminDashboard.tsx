...
export default function AdminDashboard() {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'analytics' | 'data' | 'settings'>('overview');
    ...
    const recentActivity: RecentActivity[] = [
        { id: '1', username: 'SoundMaster', action: 'Completed level: Supermarché', timestamp: 'Il y a 2 min' },
        { id: '2', username: 'EchoNavigator', action: 'New high score: 2,450,000', timestamp: 'Il y a 5 min' },
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="card">
                                ...
                                <p className="stat-number text-4xl text-accent mb-1">
                                    {stats.avgCompletionTime}s
                                </p>
                            ...
                            <div className="card">
                                ...
                                <p className="stat-number text-4xl text-success mb-1">
                                    {stats.successRate}%
                                </p>
                ...
                {activeTab === 'data' && (
                    <div className="card">
                        ...
                        <p className="text-gray-600 mb-6">
                            Export et modération des données des joueurs
                        </p>
                        <div className="space-y-4">

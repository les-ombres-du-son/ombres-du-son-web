    ...
    return (
        ...
        >
                    ...
                    >
                        {loading ? (
                            ...
                            <svg className="w-5 h-5" viewBox="0 0 24 24">
                                <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.84h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                                <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.84c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
            ...
            <div ref={shapesRef} className="absolute inset-0 pointer-events-none" aria-hidden="true">
                {/* Sound waves - left */}
                <svg className="sound-wave absolute left-4 top-1/3 w-48 h-24 text-primary opacity-70" viewBox="0 0 200 100">
                    <path
                ...
                {/* Sound waves - right */}
                <svg className="sound-wave absolute right-4 top-1/3 w-48 h-24 text-primary opacity-70" viewBox="0 0 200 100">
                    <path

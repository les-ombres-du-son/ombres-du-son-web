        ...
        >
            <div className="container-custom px-4">
                ...
                <div className="max-w-4xl mx-auto relative">
                    {/* Vertical line */}
                    <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-accent to-secondary transform md:-translate-x-1/2" aria-hidden="true" />
                        ...
                        {timeline.map((tech, index) => (
                            ...
                            >
                                ...
                                <div className="absolute left-8 md:left-1/2 transform md:-translate-x-1/2 w-16 h-16 rounded-full bg-primary flex items-center justify-center z-10 shadow-lg">
                                    <span className="stat-number text-white text-sm font-bold">
                                        {tech.year}
                                    </span>
                                </div>
                                ...
                                <div className={`ml-28 md:ml-0 md:w-5/12 ${index % 2 === 0 ? 'md:mr-auto md:pr-16' : 'md:ml-auto md:pl-16'}`}>
                                    <div className="card">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <h3 className="display-text text-xl md:text-2xl mb-2">
                                                    {tech.title}
                                                </h3>
                                                <p className="body-text text-body-md text-gray-600">
                                                    {tech.description}
                                                </p>
                                            </div>
                                        </div>

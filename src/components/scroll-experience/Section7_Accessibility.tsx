...
const accessibilityItems: AccessibilityItem[] = [
    {
        ...
        description: 'Un site accessible respecte les normes WCAG 2.1 : contrastes suffisants, navigation clavier, lecteurs d\'écran compatibles.',
        icon: '🌐',
        stat: '98% des sites ne sont pas accessibles',
    },
    {
        title: 'Documents Adaptés',
        description: 'PDF structurés avec balises, documents en braille, gros caractères, ou version audio.',
        icon: '📄',
    ...
    },
    {
        ...
        description: 'Apps avec VoiceOver (iOS) et TalkBack (Android), contrastes réglables, simplification d\'interface.',
        icon: '📱',
            ...
            <div className="container-custom px-4">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="body-text text-body-lg text-gray-300 max-w-2xl mx-auto">
                        Un droit fondamental, pas une option. Chaque personne mérite un accès égal à l'information.
                    </p>
                </div>
                        ...
                        >
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="display-text text-xl mb-2">
                                        {item.title}
                                    </h3>
                                    <p className="body-text text-body-sm text-gray-300 mb-3">
                                        {item.description}
                                    </p>
                ...
                <div className="max-w-4xl mx-auto">
                    <h3 className="display-text text-2xl text-center mb-10">
                        ...
                        {legalItems.map((item) => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <p className="body-text text-body-sm text-gray-200">
                                        {item.text}
                                    </p>
                                </div>
                            </div>

...
const testimonials: Testimonial[] = [
    {
        quote: "Être aveugle ne signifie pas ne pas voir. C'est voir différemment. L'écoute devient ma fenêtre sur le monde.",
        author: "Marie L.",
        role: "Enseignante",
    ...
    {
        quote: "Les gens pensent que je suis isolé. Mais je suis plus connecté que jamais grâce aux technologies d'assistance.",
        author: "Thomas B.",
        role: "Développeur",
    ...
    {
        quote: "Je ne vois pas vos expressions, mais j'entends votre silence. J'entends le sourire dans votre voix.",
        author: "Sophie K.",
        role: "Musicienne",
    ...
    {
        quote: "Chaque jour est une nouvelle cartographie. Je redécouvre le monde à travers le toucher et l'ouïe.",
        author: "Lucas M.",
        role: "Architecte",
            ...
            <div className="container-custom px-4">
                ...
                <div className="text-center mt-16">
                    <p className="body-text text-body-lg text-gray-300 max-w-3xl mx-auto">
                        Chaque personne déficiente visuelle a une histoire unique. 
                        Leur résilience nous inspire à créer un monde plus accessible.
                    </p>
                </div>
            </div>
        </section>
